    ...
    <aside className='hidden lg:block bg-black text-white px-7 pt-5 '>
      ...
      <div className='relative text-gray-600 focus-within:text-gray-400'>
        ...
        <input
          type='search'
          name='q'
          className='w-full py-3 text-sm text-white bg-gray-900 rounded-md pl-10 focus:outline-none focus:bg-white focus:text-gray-900'
          placeholder='search...'
          autoComplete='off'
        />
      </div>
      ...
      >
        ...
        <div className='flex flex-col my-4 gap-y-2'>
          <span className='text-lg hover:bg-sky-100 hover:bg-opacity-10 cursor-pointer'>
            word
          </span>
          <span className='text-lg hover:bg-sky-100 hover:bg-opacity-10 cursor-pointer'>
            ipsum
